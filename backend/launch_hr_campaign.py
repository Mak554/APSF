"""
launch_hr_campaign.py
Sends the HR Benefits Update phishing campaign to real employees.
"""
import httpx, sys
...
print("\n=== Creating HR Benefits Update campaign ===")
rc = client.post("/campaigns/", json={
    "name": "Live Test - HR Benefits Update",
